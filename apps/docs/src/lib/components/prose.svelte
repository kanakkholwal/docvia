...
<div
	class={cn(
		...
		"[&_a]:text-ink [&_a]:underline [&_a]:underline-offset-4 [&_a]:decoration-brand-coral [&_a]:decoration-2 hover:[&_a]:decoration-ink",
		...
		"[&_p]:my-4",
		"[&_code]:font-mono [&_code]:text-[0.9em] [&_code]:text-ink [&_code]:bg-surface-card [&_code]:rounded-sm [&_code]:px-1.5 [&_code]:py-0.5",
		...
		"[&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:border-brand-peach [&_blockquote]:bg-surface-soft [&_blockquote]:px-5 [&_blockquote]:py-4 [&_blockquote]:text-body [&_blockquote]:rounded-r-md",
