// Live package version, sourced from the npm registry so the site stays
// current without a redeploy. SSR / no-JS render the fallback (kept equal to
// the current published latest); the client refreshes it on mount.
