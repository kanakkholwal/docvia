...
| Type | Meaning |
| --- | --- |
| `heading` | A heading (`h1`–`h6`); `props.depth` carries the level. |
...
- **Collects headings** — records each `h1`–`h6` with its depth, plain text, and a collision-free slug generated by `github-slugger`.
