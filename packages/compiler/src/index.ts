...
function createDockitEnvDts(collections: readonly { name: string }[], relativeOutDir: string, hasRegistry: boolean): string {
...
function generateRegistryTs(components: Record<string, { path: string; hydrate?: boolean; defaultProps?: Record<string, unknown> }>): string {
    ...
    return [
        '// Auto-generated by @dockit/compiler — do not edit manually',
        imports,
        '',
